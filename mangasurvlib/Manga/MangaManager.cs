...
namespace mangasurvlib.Manga
{
    internal class MangaManager : IMangaManager
    {
        ...
        public void WriteMangaChapterToDb(List<MangaChapter> lChapters, State chapterState)
        {
            ...
            string sMangaPages = ctr.Get("pages").Item2;
            ...
            foreach (MangaChapter chapter in lChapters)
            {
                ...
                string sChapterNo = Convert.ToDecimal(chapter.Chapter).ToString();
                int iPageID = 0;

                dynamic page = mangaPages.FirstOrDefault(dbpage => dbpage.Name.ToUpper() == chapter.MangaPage.ToString().ToUpper());
                if (page != null)
                     iPageID = page.ID;
        ...
        private void DownloadDownloadableChapter(dynamic newChapter)
        {
            ...
            string sPages = ctr.Get("pages/" + newChapter.PageID).Item2;
